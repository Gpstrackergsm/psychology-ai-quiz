        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-4">
            ...
            <p className="max-w-3xl text-base text-slate-600 md:text-lg">
              “Know thyself” is a great rule of thumb. If you’d like to explore your personality traits, assess possible symptoms
              of a mental health condition, evaluate your conflict style, romantic impulses or more, we’re here to help. Each
              quiz contains 20 questions and takes about 3 minutes to complete.
            </p>
          </div>
          <motion.div
